...
unique_attributes_file_simple_diff = intermediate_simple_directory + "unique_attributes_diff_all.csv"
unique_attributes_file_simple_diff_all = intermediate_simple_directory + "unique_attributes_diff.csv"
